                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php  foreach($rows as $row):?>
                            <tr>
                                ...
                                <td align="center"><input type="button" value="修改" class="btn" onclick="editUser1(<?php echo $row['id'];?>)"><input type="button" value="删除" class="btn"  onclick="delUser1(<?php echo $row['id'];?>)"></td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
