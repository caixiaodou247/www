...
function editTips($id){
	...
	if($res){
		$mes = $mes="<p>修改成功!</p><a href='editTips.php?id=$id' target='mainFrame'>继续修改</a>|<a href='listTips.php' target='mainFrame'>查看美食秘笈</a>";
		return $mes;
	}
}
...
function getAllAdvertsImg(){
	$sql="select imgName,imgRoot , imgFlag from adverts";
	$rows=fetchAll($sql);
	return $rows;
}
